...
(2, 'admin', 'admin@email.com', 'admin123');
...
INSERT INTO `cart` (`id`, `order_id`, `user_id`, `product_id`, `product_name`, `quantity`, `user_name`, `price`, `timestamp`) VALUES
(68, 'TVP273946', '15', '1', '1575GHz Active GPS Antenna with SMA Male ', 2, 'Al-Amin', 220, '27:12:2021 01:34:24am');
...
--
-- Table structure for table `done_orders`
--
...
(65, 'TVP572813', '15', '5', '11.1V 3S 30c 2800mah Li-Po Battery ', 1, 'Al-Amin', 2400, '27:12:2021 01:16:31am'),
(66, 'TVP670064', '15', '3', 'Arduino Lilypad-AT Mega328P ', 1, 'Al-Amin', 400, '27:12:2021 01:16:29am'),
(67, 'TVP174765', '15', '1', '1575GHz Active GPS Antenna with SMA Male ', 2, 'Al-Amin', 220, '27:12:2021 01:16:25am');
...
(1, 3, '1.jpg', '1575GHz Active GPS Antenna with SMA Male ', 220, 5, 'Dimension: 35 x 39 x 12 mmPower supply electric voltage: DC 3V or 5VElectric current: 10mA TypeCenter frequency: 1575.42 + - 1.023 MHzTurn strength very much: RHCPIncrease a benefit: 29dB type (enlarge)Voice: 1.5dBHalt wave: max 1.8Bandwidth: 10MhzOutput resistance: 50 OhmCable: 480 cmApply to deal with contact: SMA, SMB, BNC, MCX, MMCXWork temperature: -20 ° C - + 85 ° C'),
...
(3, 1, '9.jpg', 'Arduino Lilypad-AT Mega328P ', 400, 2, 'The Lilypad Arduino is a microcontroller board designed for wearables and e-textiles. It can be sewn to fabric and similarly mounted power supplies, sensors and actuators with conductive thread. The board is based on ATmega328P.'),
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `address`, `password`, `timestamp`) VALUES
(6, 'Alamin Islam Hridoy', 'hridoy@buzz.com', '', '', '12345678', '25:12:2020 04:33:26pm'),
(10, 'Tanbin Siddique', 'tanbinsiddiqui11@gmail.com', '', '', 'password00', '27:12:2020 12:34:27am'),
(13, 'Al Amin Islam Hridoy', 'hridoy@ebuzzit.com', '', '', '12345678', '09:12:2021 11:39:25pm'),
(14, 'bzcbzxcbvzx', 'zxcbvzxcvz@sdfgs.dfg', '01456345632', 'zgbvbzcvb', '11111111', '24:12:2021 11:46:39pm'),
(15, 'Al-Amin Islam Hridoy', 'hridoy@ebuzz-it.com', '+8801521326125', 'Madartek, Bashabo, Dhaka', '11111111', '24:12:2021 06:06:54pm');
...
--
-- AUTO_INCREMENT for table `done_orders`
--
ALTER TABLE `done_orders`
